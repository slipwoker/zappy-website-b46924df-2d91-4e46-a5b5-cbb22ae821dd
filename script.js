document.addEventListener('DOMContentLoaded', function () {
  ...
  document.body.addEventListener('click', function (e) {
    ...
    const navbarEl = document.querySelector('header, nav, .navbar, [data-navbar]');
  ...
  const navbar = document.querySelector('header, nav, .navbar, [data-navbar]');
  ...
  if (contactForm) {
    ...
    function getErrorMessage(field, rule) {
      const label = field.closest('label, .form-group, .field-wrapper')
        ...
        : field;
      const fieldName = field.dataset.label || label.textContent.trim() || field.name || 'This field';
    ...
    function clearError(field) {
      const wrapper = field.closest('.form-group, .field-wrapper, p, div') || field.parentNode;
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'b46924df-2d91-4e46-a5b5-cbb22ae821dd',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'b46924df-2d91-4e46-a5b5-cbb22ae821dd';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'b46924df-2d91-4e46-a5b5-cbb22ae821dd';
